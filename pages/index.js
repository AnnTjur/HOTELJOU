    ...
    <>
      <Navbar fluid={true} className="bg-white">
        <Navbar.Brand href="https://flowbite.com/">
          <span className="self-center whitespace-nowrap text-black text-xl font-semibold dark:text-white">
            ZALL HOTEL
          </span>
        </Navbar.Brand>
        <Navbar.Toggle />
      ...
      <div className="flex justify-between mx-4 mt-4">
        <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <Image src={mountains} className="rounded-t-lg" alt="" />
          </a>
          <div className="p-5">
            <a href="#">
      ...
      <footer className="p-4 mt-8 bg-slate-900 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2022 <a className="hover:underline">Aston Indonesia</a>. All Rights
          Reserved.
        </span>
